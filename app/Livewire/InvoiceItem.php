...
class InvoiceItem extends Component
{
    ...
    public function loadInvoice($id) {
        ...
        if ($invoice) {
            ...
            $this->customer['b_phone'] = $this->formatPhoneForDisplay($this->customer['b_phone'], $this->selectedBCountry);
            $this->customer['s_phone'] = $this->formatPhoneForDisplay($this->customer['s_phone'], $this->selectedSCountry);
    ...
    private function formatPhoneForDisplay($phone, $countryId): string
    {
    ...
    public function updatedCustomerBFirstname () {
        ...
        if ($customer) {
            ...
            $this->customer['b_phone'] = $this->formatPhoneForDisplay($customer->phone, $customer->country);
            ...
            $this->customer['s_phone'] = $this->formatPhoneForDisplay($customer->phone, $customer->country);
            ...
            $this->selectedBCountry = $customer->country;
            $this->selectedSCountry = $customer->country;
            $this->dispatch('setupPhoneMask', $this->selectedBCountry);
        } else
            $this->customerId = 0;
