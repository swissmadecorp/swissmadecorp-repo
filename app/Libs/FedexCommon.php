...
function writeToLog($client){  
  ...
  /**
	 ...
	 */
	//die(__DIR__.'/../../storage/logs/fedextransactions.log');
	if (!$logfile = fopen(__DIR__.'/../../storage/logs/fedextransactions.log', "a"))
	{
   		error_func("Cannot open " . __DIR__.'/../../storage/logs/fedextransactions.log' . " file.\n", 0);
   		exit(1);
	}
