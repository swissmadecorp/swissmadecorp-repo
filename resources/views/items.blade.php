...
@section ('content')
    ...
    <div class="mx-auto pt-10 flex justify-center">
        <div class="flex md:flex-wrap justify-center space-x-8 md:space-x-10">
            <a href="/watches" class="hover:bg-red-800 uppercase flex items-center justify-center bg-black text-white py-4 px-6 text-center rounded text-sm sm:w-40 sm:text-[13px] md:w-52 md:text-lg lg:w-56 lg:text-xl transition-colors duration-300 ease-in-out">
                Shop all brands
            </a>
            <a href="#" class="hover:bg-red-800 uppercase flex items-center justify-center bg-black text-white py-4 px-6 text-center rounded text-sm sm:w-40 sm:text-[13px] md:w-52 md:text-lg lg:w-56 lg:text-xl transition-colors duration-300 ease-in-out">
                Sell you Watch
            </a>
        </div>
  </div>
    ...
    <div id="product-items"> <!-- class="row" id="product-items"> -->
        ...
        @foreach ($products as $product)
            ...
            @endif
            <a href="{{$path}}" class="inline-block relative group flex flex-col justify-between p-2 rounded-lg equal-height">
            <div>
                ...
                <div class="caption text-center truncate-4-lines md:overflow-visible md:line-clamp-none">
            ...
            <div class="mt-4">
                <div class="flex font-medium justify-center mb-4 text-gray-500 md:text-lg">
    ...
    <div class="flex justify-center mt-16">
        <a href="/newarrival" class="bg-gray-900 border-b-2 dark:hover:text-gray-300 hover:border-gray-300 hover:bg-red-800 inline-block p-4 rounded-lg text-2xl text-white transition-colors duration-300 ease-in-out uppercase">Shop all new arravals</a>
    </div>
    ...
    <div class="dark:text-gray-400 md:gap-24 gap-4 flex font-medium gap-24 justify-center p-6 text-center text-gray-400 uppercase">
        <div class="flex flex-col h-full items-center justify-center">
            <svg height="80px" width="80px" fill="#000000" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
