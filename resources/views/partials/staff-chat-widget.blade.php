        ...
        <div class="grid min-h-0 flex-1 grid-cols-[13rem,1fr]">
            ...
            <div class="flex min-h-0 min-w-0 flex-col overflow-hidden">
                <div class="border-b border-gray-100 px-5 py-4">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <div data-staff-active-meta class="mt-3 hidden flex-wrap gap-2 text-[11px] text-gray-500"></div>
                ...
                <div data-staff-conversation class="hidden min-h-0 flex flex-1 flex-col overflow-hidden">
                    <div data-staff-messages class="min-h-0 flex-1 overflow-y-auto bg-white px-5 py-4"></div>
                    <form data-staff-message-form class="shrink-0 border-t border-gray-100 bg-white px-5 py-4">
                        <label class="mb-2 block text-xs font-semibold uppercase tracking-[0.16em] text-gray-500">
                            Reply To Customer
                        </label>
