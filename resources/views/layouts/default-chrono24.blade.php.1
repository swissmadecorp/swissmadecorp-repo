...
<head>
    ...
    <link href="{{ asset('mmenu/mmenu.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('css/app-chrono24.css') }}" rel="stylesheet">
                ...
                <div class="row">
                    <div class="top-bar-left col-md-12 col-sm-12 col-xl-12">
                        <div class="top-contact">
                            <span class="phone"><i class="fas fa-phone"></i> <a href="tel:212 697 9477"> 212 840 8463</a></span><span class="separator">/</span>
                            <span class="email"><a href="mailto:info@swissmadecorp.com">info@swissmadecorp.com</a></span>
                        </div>
        ...
        <div class="container-fluid mainBk">
            <div class="row">
                ...
                <div class="sell-your-watch" >
                    <button class="btn btn-secondary btn-sm sell-your-watch">Sell your watch</button>
                </div>
            </div>
        </div>
        ...
        <div class="header-control header-nav">
            ...
            @endif
                <div class="row">
                    ...
                    <!-- <div class="col-xs-6 col-sm-3 col-md-3 col-xl-2 hidden-sm custom-menu"> -->
                        {{-- @if(!isset($sidebar)) --}}
...
@include ('sell-your-watch')
    ...
    <script src="{{ asset('mmenu/mmenu.js') }}"></script>
