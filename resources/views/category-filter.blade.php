...
@foreach ($products as $product)
    <div class="col-xs-2 col-sm-6 col-md-4 col-lg-3 col-xl-2 custom-item-width">
        <div class="thumbnail" data-id="{{ $product->id }}">
            ...
            <?php $image = $product->images->first() ?>
                ...
                @else
                <img style="width: 225px" title="{{ $product->title }}" alt="{{ $product->title }}" src="{{ URL::to('/public/images/thumbs') .  '/' . $image->location }}" alt="">
                @endif
            @else
                <img style="width: 225px" src="/public/images/no-image.jpg" alt="">
            @endif
            ...
            <?php 
                ...
                } elseif ($product->p_status==6 || $product->p_status==3) {
                    $status = 'Available';
                    $color = 'green';
                } else {
