...
<div>
        ...
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="md:grid gap-4 mb-4 grid-cols-2 p-4">
                    ...
                    <form id="inquiryForm" x-data="recaptchaInquiryHandler()">
                    <div class="col-span-2 sm:col-span-1">
                        <!-- <div class="mb-4"></div> -->
                        <x-input-standard model="inquiry.contact_name" label="fullname" text="Name" flex validation/>
                        <x-input-standard model="inquiry.company_name" label="company" text="Company" flex />
                        <x-input-standard model="inquiry.email" label="email" text="Email" flex validation />
                        <x-input-standard model="inquiry.phone" label="phone" text="Phone" flex />

                        <div class="mb-2 flex">
                            <label for="comments" class="block text-sm font-medium text-gray-900 dark:text-white w-32">Your inquiry</label>
                            <textarea id="comments" rows="4" wire:model="inquiry.notes" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                        </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <button id="submitInquiry" data-sitekey="{{config('recapcha.key') }}" type="submit" @click.prevent="handleRecaptcha"
    ...
    <script>
        ...
        function recaptchaInquiryHandler() {
                ...
                return {
                    handleRecaptcha() {
                        document.getElementById('submitInquiry').disabled = true; // Disable button to prevent multiple submissions

                        // Validate form fields using Livewire
                        @this.call('validateInquiryForm').then(isValid => {
                            if (isValid) {
