    ...
    <div x-data class="absolute dark:bg-gray-600 p-1.5 right-8 rounded-lg top-21">
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="absolute top-0 left-0 bg-gray-200 py-2 text-sm text-gray-700 dark:bg-gray-800 dark:text-gray-200" aria-labelledby="dropdownglobalpricerButton">
                    ...
                    <li>
                        <button id="endBulkEbay-modal" data-modal-target="endBulkEbay" data-modal-toggle="endBulkEbay" type="button" class="text-left block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full">End Bulk eBay Items</button>
                    </li>
                </ul>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="endBulkEbay">
                ...
                <form wire:submit.prevent="endEbayItems" class="p-4 md:p-5">
                    <input type="file" wire:model.live="importEbayFile" class="mb-4">

                    <button type="submit"
                            wire:target="endEbayItems"
                            wire:loading.attr="disabled"
                            @if(is_null($importEbayFile)) disabled @endif
                            class="bg-blue-600 cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed duration-150 ease-in-out focus:outline-none focus:ring-4 focus:ring-blue-300 font-semibold hover:bg-blue-700 px-3 py-2 rounded-lg shadow-md text-lg text-white transition">

                        <span wire:loading.remove wire:target="endEbayItems">
                            @if(is_null($importEbayFile)) Select File to Enable @else 🚀 Begin Ending eBay Items @endif
                        </span>

                        <span wire:loading wire:target="endEbayItems">
                            ⏳ Processing...
                        </span>
                    </button>

                    <div wire:loading.delay wire:target="importEbayFile" class="mt-2 text-sm text-blue-600">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                <input
                                    id="checkbox-emailAddress1"
                                    wire:model.live="showEmail.1"
                                    type="checkbox"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                >
                                <label for="checkbox-emailAddress1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Primary Email
                                </label>
                                </div>

                                @if ($showEmail[1] ?? false)
                                <input
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                <input
                                    id="checkbox-emailAddress2"
                                    wire:model.live="showEmail.2"
                                    type="checkbox"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                >
                                <label for="checkbox-emailAddress2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Secondary Email
                                </label>
                                </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="cursor-pointer px-3 py-3" wire:click="doSort('dealer_price')">
                        <x-product-dataitem :sortBy="$sortBy" :sortDirection="$sortDirection" columnName="dealer_price" displayName="Dealer Price" />
                        </th>
                ...
                <tr x-data wire:key="{{$id}}" class="odd:bg-white hover:bg-gray-100 odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class="relative text-center">
                        ...
                        <button type="button" data-id="{{$id}}" data-ebay-listed="{{ ($product->listings && $product->listings->representsExistingListing()) ? 1 : 0 }}" class="menu-btn inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                ...
                <tfoot>
                    <tr class="font-semibold text-gray-900 dark:text-white">
                        ...
                        <td colspan="5" class="px-3 py-3">${{number_format($totalCost,0)}}</td>
    ...
    $(document).ready( function() {
        ...
        $('.menu-btn').popupMenu({
            ...
            dataMapper: ($button) => ({
                ...
                ebayListed: $button.attr('data-ebay-listed')
            }),
            selectors: {
                menuItem: ".menu-item"
            },
            ...
            onMenuOpen: (data, menu) => {
                ...
                const hasEbayListing = Number(data.ebayListed) === 1;

                menu.find(".menu-item").attr("data-id", productId);
                menu.find("li.ebay").text(hasEbayListing ? "Update on eBay" : "Submit to eBay");
