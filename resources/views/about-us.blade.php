...
<div class="content">
    <div style="background: #fff; padding: 25px;border-radius: 4px;">
        <div class="container">
            <h5>Located in the bustling heart of the renowned Diamond District on 47th Street in New York,
            ...
            <ul>
            <li>For a quarter-century, we have been entrenched in the wholesale watch industry, steadfastly providing our clientele with exclusively authentic timepieces.</li> 
            <li>We approach our business with utmost dedication, prioritizing customer satisfaction and fostering the expansion of our clientele. </li> 
            <li>For over two decades, we have proudly held membership with the prestigious International Watch and Jewelers Guild (IWJG). </li> 
            <li>We are also members of <b>Chrono24, eBay, IWJG, and BBB</b>. 
                <ol class="members">
                    <li><a target="_blank" href="https://www.chrono24.com/dealer/212swissmade/index.htm"><img height="120" width="100" alt="Chrono24 Trusted Seller" src="/images/trusted-seller-icon.png"></a></li>
                    <li><a target="_blank" href="https://feedback.ebay.com/ws/eBayISAPI.dll?ViewFeedback2&amp;userid=swissmadecorp"><img height="100" width="70" alt="Chrono24 Trusted Seller" src="/images/ebay_logo.jpg"></a></li>
                    <li><a target="_blank" href="http://www.iwjg.com/" style=""><img height="100" width="100" alt="Chrono24 Trusted Seller" src="/images/iwjg.jpg"></a></li>
            ...
            <h4 class="h_header">Authenticity</h4>
            ...
            <p>Moreover, we place a premium on the quality and craftsmanship of our watches. Each timepiece undergoes rigorous inspection and testing to ensure it meets our exacting standards. Our commitment to excellence extends to our customer service as well. Our knowledgeable and friendly team is always on hand to assist you, providing expert guidance and answering any questions you may have about our products.</p>
            <p>Furthermore, we offer competitive pricing without compromising on the authenticity or quality of our watches. We understand the value of a sound investment, and we strive to provide timepieces that not only stand the test of time but also represent an exceptional value proposition.</p>
            <p>As a testament to our confidence in the durability of our products, we offer a comprehensive warranty on every watch in our collection. This serves as a guarantee of our commitment to your satisfaction and ensures that you can enjoy your purchase with peace of mind.</p>
            <p>In choosing our timepieces, you're not only acquiring a beautiful and authentic watch, but you're also becoming a part of a community that values genuine craftsmanship and exceptional service. We invite you to explore our collection and experience the difference for yourself. Thank you for considering us for your timekeeping needs.</p>

            <h4 class="h_header">Pre-Owned Watches Warranty</h4>
            ...
            <p>For those who prefer a more personal touch, we are delighted to offer the option of in-person pick-ups. However, we kindly request that appointments be scheduled in advance, allowing us to make the necessary arrangements to welcome you to our store with the utmost attention and care.</p>
            ...
            <h4 class="h_header">Return Policy for Watches and Jewelry:</h4>
            <p>We kindly request that any watches or jewelry being returned to us come in their original packaging, which encompasses various aspects. This includes considerations such as customized pieces, those with engravings, items that have been resized, and those that may bear signs of wear such as damage or scratches. Additionally, we ask that all original accessories be present, including stickers, tags, plastic wraps, and any accompanying documents or papers.</p>
            <p>Please understand that if an item is found to be incomplete or has been altered in any way, we regret to inform you that it <i>CANNOT</i> be accepted for return. We believe this policy ensures that every piece leaving our care is in the best possible condition for our valued customers.</p>
            <p>Furthermore, we kindly request that all shipping charges be handled by the customer. In addition, there may be a nominal restocking fee of 5%, which we hope you appreciate is necessary to cover the costs associated with processing and ensuring the quality of returned items. It's important to note that each watch will be subjected to a thorough inspection prior to the issuance of any refunds. We believe this meticulous process is a testament to our commitment to quality and customer satisfaction.</p>
            <p><b>Special Note for NEW ROLEX Sales:</b></p>
