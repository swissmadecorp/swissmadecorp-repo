...
<form method="POST" action="{{route('products.update',[$product->id])}}" accept-charset="UTF-8" id="productform">
    ...
    @if ($product->p_status == 10) <?php // Returned to Vendor?>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="meta-tags" data-toggle="tab" href="#metatags" role="tab" aria-controls="meta-tags" aria-selected="false">Meta Tags</a>
        </li>
    </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" placeholder="Enter title for this product" id="title-input" value="{{ $product->title }}" name="title">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="form-group row">
                <label for="case_size-input" class="col-3 col-form-label">Case Size</label>
                <div class="col-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                <select class="custom-select form-control" id="gender-input" name="p_gender">
                    @foreach (Gender() as $key => $gender)
                        <option <?php echo !empty($product->p_gender) && $product->p_gender==$gender ? 'selected' : '' ?> value="{{ $key }}">{{ $gender }}</option>
                    @endforeach
                </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-9">
                <select class="custom-select form-control" id="strap-input" name="p_strap">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                <select class="custom-select form-control" id="clasp-input" name="p_clasp">
            ...
            <div class="form-group row">
                <label for="bezel_features-input" class="col-3 col-form-label">Bezel Features</label>
                <div class="col-9">
        ...
        <div class="col-md-7">
            ...
            <div class="form-group row">
                <label for="webprice-input" class="col-3 col-form-label">Website</label>
                <div class="col-9 input-group">
                    <div class="input-group-addon">$</div>
            ...
            <div class="form-group row">
                <label for="price3P-input" class="col-3 col-form-label">Chrono24</label>
                <div class="col-9 input-group">
                    <div class="input-group-addon">$</div>
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    ...
                    @elseif ($product->p_status == 9) 
                        <?php $repair = $product->repair->first() ?>
                        <input type="hidden" value="{{ $repair->id }}" name="repair_id">
                        <span style="font-weight: bold">At Repair Center:</span> <span style='color:red'>{{ $repair->assigned_to . ' - ' . unserialize($repair->pivot->job) }}</span>
                    @endif
            ...
            <div class="form-group row longdescription">
                ...
                <div class="col-9">
                <textarea rows="4" class="form-control" type="text" placeholder="Enter a long description" name="p_longdescription" id="longdescription-input"><?php echo !empty($product->p_longdescription) ? $product->p_longdescription : '' ?></textarea>
                </div>
            </div>
            <div class="form-group row">
    ...
    <div class="form-group row">
        <div class="col-12">
            ...
            <div id="ebay-lising-input" style="height: 50px;line-height: 30px;position:relative" class="form-control">
                @if ($product->listings->listitem)
                    <a target="_blank" href="https://www.ebay.com/itm/{{ $product->listings->listitem }}">
                    {{ $product->listings->listitem }}
                    </a>
                @else
                    <div id="ebay_response">Error: Item not created.</div>
                @endif
                <div style="position: absolute;top: 7px;right: 3px;"><button class="btn btn-sm btn-warning ebay_resubmit">Re-submit</button></div>
            </div>
        </div>    
    </div>
    @else
        <button class="btn btn-sm btn-warning ebay_resubmit">Submit to eBay</button>
    @endif
    ...
    <table id="orders" class="table table-striped table-bordered hover" cellspacing="0" width="100%">
        ...
        ?>
        <tr <?= $colColor ? 'style="background: '.$colColor .'"' : ''?>>
            ...
            <td class="text-right"><?= $colColor ? "-" : '' ?>${{ number_format($product->pivot->price,2) }}</td>   
        </tr>
        @endforeach
    </tbody>
    </table>
    ...
    <div class="tab-pane fade" style="padding: 16px" id="metatags" role="tabpanel" aria-labelledby="meta-tags">
    <div class="form-group row metatitle">
                <label for="metatitle-input" class="col-3 col-form-label">Meta Title</label>
                <div class="col-9">
                <input class="form-control" value="<?php echo !empty($product->p_metatitle) ? $product->p_metatitle : '' ?>" type="text" name="p_metatitle" id="metatitle-input" >
                </div>
            </div>
        
            <div class="form-group row metadescription">
                <label for="metadescription-input" class="col-3 col-form-label">Meta Description</label>
                <div class="col-9">
                <textarea rows="4" class="form-control" type="text" name="p_metadescription" id="metadescription-input"><?php echo !empty($product->p_metadescription) ? $product->p_metadescription : '' ?></textarea>
                </div>
            </div>

            <div class="form-group row">
                <label for="keywords-input" class="col-3 col-form-label">Keywords</label>
                <div class="col-9">
                    <input class="form-control" value="<?php echo !empty($product->p_keywords) ? $product->p_keywords : '' ?>" type="text" name="p_keywords" id="keywords-input" >
                </div>
            </div>  
    </div>
                ...
                <form id="form_onhold">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="btn btn-primary submit-onhold" type="submit" value="Reserve">
                            </div>
                        </div>
                    </div>
                </form>
...
<div id="product-repair" style="width: 500px;display:none">
    <div class="popup-header">
        <h3 style="padding: 12px; text-align: left">Repair Form</h3>
    </div>

    <div class="container" style="padding: 20px 25px 0px;">
        <div class="row">
            <div class="pb-2">Specify the watchmaker's name and the reason why below.</div>
            <div class="col-md-12 form-panel">
                <form id="form_repair">
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="company-input" class=" col-form-label">Watchmaker's Name</label>
                            <div>
                                <input class="form-control" autocomplete="off" type="text" name="watchmaker" id="watchmaker-input">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label for="amount-input" class="col-form-label">Reason for Repair</label>
                            <div>
                                <input class="form-control" autocomplete="off" type="text" name="repair_reason" id="repair_reason-input">
                            </div>
                        </div>
                        
                        <div class="col-md-12">
                            <label for="repair_notes-input" class="col-form-label">Repair Notes</label>
                            <div>
                                <textarea rows="4" class="form-control" type="text" name="repair_notes" id="repair_notes-input"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group float-right">
                                <input class="btn btn-primary submit-repair" type="submit" value="Submit">
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    $(document).ready( function() {
        ...
        $('.ebay_resubmit').click( function(e) {
            e.preventDefault();
            $.ajax ( {
                type: 'post',
                url: "{{route('ebay.resubmit')}}",
                data: {
                    product_id: {{ $product->id }},
                },
                success: function(response) {
                    $('#ebay_response').text('Processing ...')
                }
            })
        })
        ...
        $(document).on('change', '.categories', function() {
            ...
            if (foundIn == 0) {
                $.confirm({
                    title: 'Alert',
                    content: 'Category by the name "'+$(_this).val()+'" does not exist. Do you want to create it?',
                    buttons: {
                        formSubmit: {
                            text: 'Yes',
                            btnClass: 'btn-blue',
        ...
        $('#status-input').change( function () {
            var status = $('#status-input :selected').text();
            if (status == "On Hold" || status == "Repair") { 
               // $('.inquiry-form')[0].reset();
                $.fancybox.open({
                    src: (status == "On Hold" ? "#product-inquiry" : "#product-repair"),
                    type: 'inline',
                    afterClose: function () {
        ...
        $('.submit-onhold,.submit-repair').click( function (e) {
            e.preventDefault();
            var onData;
            if($("#product-inquiry").is(":visible")) {
                if ($('#company-input').val() == '' || $('#amount-input').val() == '') return false
                onData = {
                    form: $('#form_onhold').serialize(),
                    _id: $("input[name='_id']").val(),
                    status: $('#status-input :selected').val()
                }
            } else {
                if ($('#watchmaker-input').val() == '' || $('#repair_reason-input').val() == '') return false
                onData = {
                    form: $('#form_repair').serialize(),
                    _id: $("input[name='_id']").val(),
                    status: $('#status-input :selected').val()
                }
            }
        ...
        var config = {
            ...
            '.chosen-select-no-results': { no_results_this: 'Oops, nothing found!' },
            '.chosen-select-rtl'       : { rtl: true },
            '.chosen-select-width'     : { width: '95%' },
            'no_results_this'          : "No result found. Press enter to add "
        }
