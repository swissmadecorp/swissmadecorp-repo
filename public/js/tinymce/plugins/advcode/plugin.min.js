...
!function(l) {
    "use strict";
    var e, t, n, r, o, i, u, c, a = function(e) {
        ...
        return t ? f(a(t[1]), a(t[2]), a(t[3])) : f(0, 0, 0)
    }, m = function(e, t) {
        var n = s(e.major, t.major);
        if (0 !== n)
            return n;
        var r = s(e.minor, t.minor);
        if (0 !== r)
            return r;
        var o = s(e.patch, t.patch);
        return 0 !== o ? o : 0
    }, p = function(e) {
        return d([(t = e).majorVersion, t.minorVersion].join(".").split(".").slice(0, 3).join("."));
        var t
    }, h = function(e, t) {
        return !!e && -1 === m(p(e), d(t))
    }, g = function(r, o) {
        return function() {
        ...
        log: g(l.window, "log"),
        error: g(l.window, "error"),
        warn: g(l.window, "warm")
    }, v = function() {}, w = function(e) {
        return function() {
            return e
        }
    }, b = w(!1), _ = w(!0), T = function() {
        return C
    }, C = (e = function(e) {
        return e.isNone()
    }
    ...
    {}), k = function(e, t, n) {
        ...
        var r, o, i, u, c, a;
        e in I ? (c = n,
        null === (a = I[e]).module ? a.callbacks.push(c) : c(a.module)) : (r = e,
        o = t,
        i = n,
        u = l.document.createElement("script"),
    ...
    i = void 0,
    function(e) {
        "object" == typeof u && void 0 !== c ? c.exports = e() : "function" == typeof i && i.amd ? i([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e()
    }(function() {
    ...
    var A = O.exports.boltExport
      ...
      , L = function(e, t, n, r) {
        ...
        var o, i, u = (o = e,
        {
            ...
            completeIfAfterLt: function(t) {
                return i(t, function() {
                    var e = t.getCursor();
                    return "<" === t.getRange(o.Pos(e.line, e.ch - 1), e)
                })
            },
            completeIfInTag: function(t) {
                return i(t, function() {
                    var e = t.getTokenAt(t.getCursor());
                    return !!("string" !== e.type || /['"]/.test(e.string.charAt(e.string.length - 1)) && 1 !== e.string.length) && o.innerMode(t.getMode(), e.state).state.tagName
                })
            }
        }), c = {
            ...
            mode: "text/html",
            value: r
        }, a = e(t, c), l = function(e) {
            27 !== e.keyCode && e.stopPropagation()
        };
        return t.addEventListener("keyup", l),
        ...
        }, 200),
        {
            ...
            unbind: function() {
                ...
                t.removeEventListener("keypress", l)
            }
        }
    }
      , F = function(t, n) {
                ...
                if (!function(e, t) {
                    for (var n = 0, r = e.length; n < r; n++)
                        if (t(e[n], n))
                            return !0;
                    return !1
                }(l.document.styleSheets, function(e) {
                    return e.href === t
                })) {
                    var e = l.document.createElement("link");
                    e.rel = "stylesheet",
                    e.type = "text/css",
                    e.href = t,
      ...
      , R = function(e, o) {
        e.windowManager.open({
            ...
            onPostRender: function() {
                var e, t, n, r = this.getRoot();
                t = r.find("form > *")[0],
                n = r.getEl("body"),
                (e = new tinymce.ui.Throbber(n)).show(1e3),
                o.onPostRender(t).then(function() {
                    e.hide(),
                    r.statusbar.items().disabled(!1)
                })
            },
            onSubmit: function(e) {
                o.onSubmit(e.data)
      ...
      , D = function(r, o) {
        var t, i = F(o.codeMirrorScriptUrl, o.codeMirrorCssUrl), u = (t = N(E.none()),
        {
            clear: function() {
                t.set(E.none())
            },
      ...
      , q = function(t, n) {
        ...
        r && 1 === m(p(r), d(o))) {
            ...
            e = V(V({}, u), {
                init: function(e) {
                    ...
                    new A(function(e) {
                        o.style.width = "100%",
                        o.parentElement.classList.add("mce-codemirror"),
                        e(F(i.codeMirrorScriptUrl, i.codeMirrorCssUrl).then(function(e) {
                            var t = L(e, o, i)
                              , n = t.cmi
                              , r = t.unbind;
                            return {
                                getValue: function() {
                                    return n.doc.getValue()
                                },
                                setValue: function(e) {
                                    return n.doc.setValue(e)
                                },
                                destroy: function() {
                                    return r()
                                }
        ...
        var a = {
            ...
            onSubmit: function(e) {
                U(t, e.getData().codeview),
                e.close()
            }
        };
        t.windowManager.open(a)
    }
      , B = function(m, p, h) {
        return function() {
            var e, t, n, r, o, i, u, c, a, l, s, f, d = {
                customEditorScriptUrl: (t = h) + "/customeditor.min.js",
                codeMirrorScriptUrl: (s = e = p,
                f = t,
                s.getParam("codemirror_script", f + "/codemirror.min.js", "string")),
                codeMirrorCssUrl: (a = e,
                l = t,
                a.getParam("codemirror_css", l + "/codemirror.min.css", "string")),
                lineWrapping: (c = e,
                c.getParam("codemirror_linewrapping", !0, "boolean")),
                lineNumbers: (u = e,
                u.getParam("codemirror_linenumbers", !0, "boolean")),
                foldGutter: (i = e,
                i.getParam("codemirror_foldgutter", !0, "boolean")),
                theme: (o = e,
                o.getParam("codemirror_theme", "default", "string")),
                direction: (r = e,
                "rtl" === r.getBody().dir ? "rtl" : "ltr"),
                gutter: (n = e,
                n.getParam("codemirror_gutter", !0, "boolean"))
            };
            m(p, d)
        }
    };
    tinymce.PluginManager.add("advcode", function(e, t) {
        return h(tinymce, "4.3.13") ? (y.error("The advcode plugin requires at least 4.3.13 version of TinyMCE."),
        function() {}
        ) : (h(tinymce, "5.0.0") ? (u = B(D, i = e, t),
        i.addCommand("mceCodeEditor", u),
        i.addButton("code", {
            icon: "code",
            tooltip: "Source code",
            onclick: u
